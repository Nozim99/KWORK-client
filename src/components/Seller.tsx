...
export default function Seller() {
  ...
  return (
    <>
      <div className='h-10 bg-neutral-800 sm:hidden'>
        <div className='flex items-center'>
          <FontAwesomeIcon className='relative left-6 text-neutral-600' icon={faMagnifyingGlass} />
          <input onChange={(e) => setSearch(e.target.value)} value={search} className='outline-none py-0.5 pl-8 pr-8 w-96 rounded-l' type="text" placeholder='Find Services' />
          <FontAwesomeIcon className={'relative right-5 text-neutral-600 cursor-pointer ' + (search ? "" : "opacity-0 pointer-events-none")} icon={faXmark} />
          <button className='bg-green-500 text-white px-5 rounded-r py-0.5 relative right-2.5'>Search</button>
        </div>
      </div>

      <div className='bg-[#F6F6F6] pb-10 lg:flex lg:justify-between lg:items-start lg:pt-10'>
        {/* Left */}
        <div className='bg-white border-b border-neutral-300 lg:border lg:ml-2 lg:rounded-lg lg:container lg:mx-auto lg:w-2/4 xl:w-2/6'>
          <div className='max-lg:container mx-auto text-center py-6 border-neutral-300 min-[860px]:flex min-[860px]:justify-between min-[860px]:items-center lg:flex-col lg:ml-4 lg:border lg:rounded-lg lg:border-0'>
